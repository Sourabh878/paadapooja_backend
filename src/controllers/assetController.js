...
const postAssets = async (req, res) => {
    ...
    try {
        ...
        const assetRes = await client.query(assetQuery, [
            req.body.asset_code, req.body.asset_name, req.body.asset_type,
            req.body.description, req.body.purchase_type, req.body.purchase_date || null,
        ...
        if (req.body.purchase_type === 'Donation' && req.body.donor_name) {
            await client.query(`
                ...
                VALUES ($1, $2, $3, $4, $5)`,
                [req.body.donor_name, req.body.donor_phone, req.body.donor_address, req.body.purchase_date || new Date(),assetId]
            );
        ...
        if (req.body.asset_type === 'PROPERTY') {
            await client.query(`
                ...
                VALUES ($1, $2, $3, $4, $5)`, 
                [assetId, req.body.property_type, req.body.location, req.body.total_area_sqft, req.body.rental_rate]
            );
        } else {
            await client.query(`
                INSERT INTO ornament_assets (asset_id, material_type, purity, gross_weight, net_weight, locker_no, stone_weight ,length)
                VALUES ($1, $2, $3, $4, $5, $6,$7,$8)`,
                [assetId, req.body.material_type, req.body.purity, req.body.gross_weight, req.body.net_weight, req.body.locker_no,req.body.stone_weight,req.body.O_length]
            );
        }
        ...
        if(req.body.policy_number){
            await client.query(`
                ...
                VALUES ($1, $2, $3, $4)`,
                [assetId, req.body.policy_number, req.body.insured_value || 0, req.body.expiry_date || null]
            );
        }
        ...
        res.status(201).json({ success: true, message: "Asset and Donor details recorded successfully" });
    } catch (err) {
...
const updateAsset = async (req, res) => {
    ...
    try {
        ...
        await client.query(
            ...
            [req.body.asset_name, req.body.purchase_cost, req.body.current_value, id]
        ).then(()=>{
        ...
        if (req.body.asset_type === "PROPERTY") {
            await client.query(
                ...
                [req.body.details.property_type, req.body.details.location, req.body.details.rental_rate,req.body.details.total_area_sqft, id]
            );
        } else {
            await client.query(
                ...
                [req.body.details.material_type, req.body.details.purity, req.body.details.gross_weight,req.body.details.net_weight,req.body.details.stone_weight,req.body.details.length,req.body.details.locker_no, id]
            );
        }
...
module.exports = { postAssets, getAllAssets, getAssetById, updateAsset,deleteImg,AddImage};
